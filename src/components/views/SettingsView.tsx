      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <div className="bg-white rounded-2xl p-6 border border-slate-200/80 shadow-2xs space-y-4">
          <div className="flex items-center gap-2.5 pb-3 border-b border-slate-100">
            ...
            <div>
              <h3 className="text-sm font-bold text-slate-900">Role-Based Access Control (15 Operational Roles)</h3>
              <p className="text-xs text-slate-500">Fine-grained operational permissions across the turnkey lifecycle</p>
            </div>
          </div>
